...
(function () {
  ...
  const quizTree = {
    ...
    focus_4: {
      ...
      options: [
        { text: "Great — 7-9 hours, feel rested", icon: "smile", scores: { focus: 1 }, next: "focus_5" },
        { text: "Okay — could be better", icon: "meh", scores: { sleep: 1 }, next: "focus_5" },
        { text: "Poor — I struggle to sleep well", icon: "frown", scores: { sleep: 3 }, next: "focus_5" },
        { text: "Inconsistent — varies a lot", icon: "shuffle", scores: { sleep: 2 }, next: "focus_5" }
      ]
    },
    focus_5: {
      ...
      options: [
        { text: "Rarely — I manage stress well", icon: "heart", scores: { focus: 1 }, next: null },
        { text: "Sometimes — during busy periods", icon: "bar-chart", scores: { energy: 1 }, next: null },
        { text: "Often — it affects my daily life", icon: "alert-triangle", scores: { energy: 3 }, next: null },
        { text: "Yes — it's a major issue for me", icon: "alert-circle", scores: { energy: 4 }, next: null }
      ]
    },
    ...
    gym_5: {
      ...
      options: [
        { text: "Build muscle / Get bigger", icon: "trending-up", scores: { gym: 2 }, next: null },
        { text: "Lose fat / Get lean", icon: "flame", scores: { gym: 1, energy: 1 }, next: null },
        { text: "Improve performance / PRs", icon: "trophy", scores: { gym: 2 }, next: null },
        { text: "General fitness / Stay active", icon: "heart-pulse", scores: { gym: 1, wellness: 1 }, next: null }
      ]
    },
    ...
    sleep_3: {
      ...
      options: [
        { text: "Yes — phone, laptop, or TV", icon: "smartphone", scores: { sleep: 2 }, next: "sleep_4" },
        { text: "Sometimes", icon: "monitor", scores: { sleep: 1 }, next: "sleep_4" },
        { text: "No — I have a wind-down routine", icon: "book-open", scores: { sleep: 1 }, next: "sleep_4" }
      ]
    },
    sleep_4: {
      ...
      options: [
        { text: "Low — I'm pretty relaxed", icon: "heart", scores: { sleep: 1 }, next: "sleep_5" },
        { text: "Moderate — manageable", icon: "scale", scores: { energy: 1 }, next: "sleep_5" },
        { text: "High — it keeps me up at night", icon: "alert-triangle", scores: { energy: 3, sleep: 1 }, next: "sleep_5" },
        { text: "Very high — I'm overwhelmed", icon: "alert-circle", scores: { energy: 4, sleep: 1 }, next: "sleep_5" }
      ]
    },
    sleep_5: {
      ...
      options: [
        { text: "No — this would be my first", icon: "plus", scores: { sleep: 1 }, next: null },
        { text: "Melatonin — it helped a bit", icon: "pill", scores: { sleep: 1 }, next: null },
        { text: "Melatonin — didn't help", icon: "x-circle", scores: { sleep: 2 }, next: null },
        { text: "Yes — various things", icon: "package", scores: { sleep: 2 }, next: null }
      ]
    },
    ...
    energy_3: {
      ...
      subtitle: "Food is your primary energy source",
      options: [
        { text: "Balanced — regular meals, good variety", icon: "apple", scores: { energy: 1 }, next: "energy_4" },
        { text: "I skip meals / eat irregularly", icon: "fast-forward", scores: { energy: 2, wellness: 1 }, next: "energy_4" },
        { text: "High in processed food / sugar", icon: "candy", scores: { energy: 2, wellness: 1 }, next: "energy_4" },
        { text: "Restricted diet (keto, IF, vegan)", icon: "leaf", scores: { wellness: 2 }, next: "energy_4" }
      ]
    },
    energy_4: {
      ...
      options: [
        { text: "Plenty — 2+ litres", icon: "droplets", scores: { energy: 1 }, next: "energy_5" },
        { text: "Some — about 1 litre", icon: "droplet", scores: { energy: 1, wellness: 1 }, next: "energy_5" },
        { text: "Not enough — I forget to drink", icon: "cloud-off", scores: { wellness: 2 }, next: "energy_5" }
      ]
    },
    energy_5: {
      ...
      options: [
        { text: "Yes — 3+ times per week", icon: "dumbbell", scores: { gym: 1 }, next: null },
        { text: "Sometimes — 1-2 times per week", icon: "footprints", scores: { energy: 1 }, next: null },
        { text: "Rarely — I struggle to find time", icon: "clock", scores: { energy: 1 }, next: null },
        { text: "No — I'm too tired to exercise", icon: "battery-low", scores: { energy: 2, sleep: 1 }, next: null }
      ]
    },
    ...
    wellness_2: {
      ...
      subtitle: "Gaps in nutrition are the first place to look",
      options: [
        { text: "Varied and balanced", icon: "apple", scores: { wellness: 1 }, next: "wellness_3" },
        { text: "Good but missing some food groups", icon: "help-circle", scores: { wellness: 2 }, next: "wellness_3" },
        { text: "Needs improvement", icon: "alert-triangle", scores: { wellness: 3 }, next: "wellness_3" },
        { text: "Vegan / Vegetarian", icon: "sprout", scores: { wellness: 3 }, next: "wellness_3" }
      ]
    },
    wellness_3: {
      question: "What's your age range?",
      subtitle: "Nutritional needs change with age",
      options: [
        { text: "18-24", icon: "user", scores: { wellness: 1 }, next: "wellness_4" },
        { text: "25-34", icon: "user", scores: { wellness: 1 }, next: "wellness_4" },
        { text: "35-44", icon: "user", scores: { wellness: 2 }, next: "wellness_4" },
        { text: "45+", icon: "user", scores: { wellness: 3 }, next: "wellness_4" }
      ]
    },
    wellness_4: {
      ...
      options: [
        { text: "Yes — I'm outside daily", icon: "sun", scores: { wellness: 1 }, next: "wellness_5" },
        { text: "Some — a few times a week", icon: "cloud-sun", scores: { wellness: 1 }, next: "wellness_5" },
        { text: "Not much — mostly indoors", icon: "home", scores: { wellness: 2 }, next: "wellness_5" },
        { text: "Rarely — I work from home", icon: "laptop", scores: { wellness: 3 }, next: "wellness_5" }
      ]
    },
    wellness_5: {
      question: "Are you currently taking any supplements?",
      subtitle: "We want to complement, not duplicate",
      options: [
        { text: "No — starting fresh", icon: "plus", scores: { wellness: 1 }, next: null },
        { text: "Just a basic multivitamin", icon: "pill", scores: { wellness: 1 }, next: null },
        { text: "A few different supplements", icon: "package", scores: { wellness: 1 }, next: null },
        { text: "Yes — but I'm not sure they work", icon: "help-circle", scores: { wellness: 2 }, next: null }
      ]
    }
  };
  ...
  const stackRecommendations = {
    focus: {
      name: "Focus Stack",
      handle: "focus-stack",
      description: "Sharpen your mind with our science-backed focus formula",
      products: [
    ...
    gym: {
      ...
      description: "Train harder, recover faster, build more muscle",
      products: [
    ...
    sleep: {
      ...
      description: "Fall asleep faster and wake up feeling truly rested",
      products: [
    ...
    energy: {
      name: "Stress & Energy Stack",
      handle: "stress-energy-stack",
      description: "Sustained energy and stress resilience throughout your day",
      products: [
    ...
    wellness: {
      ...
      description: "Your daily foundation for optimal health and vitality",
      products: [
      ...
      this.container.innerHTML = `
        <div class="quiz-results-page">
          ...
          <div class="quiz-results__header">
            ...
            <h2 class="quiz-results__title">Your Personalised Stack</h2>
            <p class="quiz-results__subtitle">Based on your answers, we recommend the <strong>${stack.name}</strong></p>
            <p class="quiz-results__desc">${stack.description}</p>
